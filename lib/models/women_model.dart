...
class WomenModel {
  ...
  String getBackGroundImage() {
    if (bmi < 18.5) {
      backImage = "asset/WunderWeight.jpg";
    } else if (bmi >= 18.5 && bmi < 24.9) {
      backImage = "asset/WnormalWeight.jpg";
    } else if (bmi >= 24.9 && bmi < 29.9) {
      backImage = "asset/WoverWeight.jpg";
    } else if (bmi >= 29.9 && bmi < 34.9) {
      backImage = "asset/Wobese.jpg";
    } else if (bmi >= 34.9 && bmi < 39.9) {
      backImage = "asset/Wobese.jpg";
    } else if (bmi >= 39.9) {
      backImage = "asset/Wobese.jpg";
